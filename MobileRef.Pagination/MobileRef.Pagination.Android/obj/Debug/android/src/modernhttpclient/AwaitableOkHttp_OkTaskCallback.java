		...
		com.squareup.okhttp.Callback
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ModernHttpClient.AwaitableOkHttp/OkTaskCallback, ModernHttpClient, Version=2.3.0.0, Culture=neutral, PublicKeyToken=null", AwaitableOkHttp_OkTaskCallback.class, __md_methods);
	}
	...
	public AwaitableOkHttp_OkTaskCallback () throws java.lang.Throwable
	{
		...
		if (getClass () == AwaitableOkHttp_OkTaskCallback.class)
			mono.android.TypeManager.Activate ("ModernHttpClient.AwaitableOkHttp/OkTaskCallback, ModernHttpClient, Version=2.3.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
